...
plugins.wcjsonapi_sr = {
  ...
  item_list_column: function (params) {
    ...
    if ( col['name'] == 'wcjsonapi_sr_send_to_wp') {
      ...
      params.column = '<img class="wc-jsonapi-sr-send-item-button" style="cursor:pointer;" id="send_to_wp_for_' + item.id + '" src="' + URLS.images + '/wcjsonapi_sr/wordpress_logo.svg" height="16"/>';
